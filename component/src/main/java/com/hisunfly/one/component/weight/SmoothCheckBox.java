...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_UNCHECKED = Color.parseColor("#33000000");
    ...
    private void init(AttributeSet attrs) {
        ...
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.SmoothCheckBox_box_stroke_width, DensityUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private void drawBorder(Canvas canvas) {
        ...
        if (isChecked()){
            ...
            mFloorPaint.setStrokeWidth(0);
            radius = mCenterPoint.x;
        }else {
            mFloorPaint.setStyle(Paint.Style.STROKE);
            mFloorPaint.setStrokeWidth(mStrokeWidth);
            radius = mCenterPoint.x - mStrokeWidth;
        }
